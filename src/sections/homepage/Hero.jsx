    ...
    return (
       <Container>
           <section className="flex flex-col md:flex-row items-start">
               <div className="mb-[3.44rem] md:mb-0">
    ...
    return (
        <section className="bg-talk-cover pt-20 bg-[#E6F7F3] my-24">
            <div className="flex flex-col items-center">
                ...
                <h3 className="mt-4 font-black font-Satoshi text-[42px]">
...
export const ReviewsSection = () => {
    return (
        <section className="bg-[#F5F5F9] my-[6rem] py-[5.44rem] px-[6.44rem] ">
